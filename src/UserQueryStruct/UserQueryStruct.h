...
#define _8KBLEN			8192
#define _160KBLEN			8192*10*10*10
...
#define KEY_USER_IDENTITY_ID_NAME	"/api/credit/IdentityIDName"
...
void operator =(const M_HIVELOG &hive) 
{
	...
	iProvider		=	hive.iProvider;
	strCarrier		=	hive.strCarrier;
...
typedef struct ReqApiGateWayConfig
{

	std::string mStrHostInfo;
	std::string mStrUrlPath;
	std::string mStrCname;
	std::vector<std::string> mStrReqParams;
	std::string mStrApiKey;
	int mIntIsHttps;
	int mIntIsVerify;
